...
export default class Form extends React.Component<IProps, IState> {
    ...
    render(){
        const { gallery, command, changeHandler, checkBoxHandler } = this.props;
