...
namespace XComm.Api.Migrations
{
    ...
    [Migration("20231204032640_addRoleGroupIdAdmin")]
    partial class addRoleGroupIdAdmin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("XComm.Api.DataModel.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Attempt = 0,
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2023, 12, 4, 10, 26, 40, 180, DateTimeKind.Local).AddTicks(7592),
                        ...
                        new
                        {
                            ...
                            Attempt = 0,
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2023, 12, 4, 10, 26, 40, 180, DateTimeKind.Local).AddTicks(7621),
                            Email = "winkawinoy@gmail.com",
                            FirstName = "User",
                            Id = 2L,
                            LastName = "One",
            ...
            modelBuilder.Entity("XComm.Api.DataModel.AuthorizationGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2023, 12, 4, 10, 26, 40, 180, DateTimeKind.Local).AddTicks(7840),
                            Role = "Products",
                            RoleGroupId = 1L
                        },
                        new
                        {
                            Id = 2L,
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2023, 12, 4, 10, 26, 40, 180, DateTimeKind.Local).AddTicks(7842),
                            Role = "Orders",
                            RoleGroupId = 1L
                        },
                        new
                        {
                            Id = 3L,
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2023, 12, 4, 10, 26, 40, 180, DateTimeKind.Local).AddTicks(7843),
                            Role = "Categories",
                            RoleGroupId = 2L
                        },
                        new
                        {
                            Id = 4L,
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2023, 12, 4, 10, 26, 40, 180, DateTimeKind.Local).AddTicks(7844),
                            Role = "Variants",
                            RoleGroupId = 2L
                        },
                        new
                        {
                            Id = 5L,
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2023, 12, 4, 10, 26, 40, 180, DateTimeKind.Local).AddTicks(7845),
                            Role = "Products",
                            RoleGroupId = 2L
                        },
                        new
                        ...
                        new
                        {
                            Id = 7L,
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2023, 12, 4, 10, 26, 40, 180, DateTimeKind.Local).AddTicks(7846),
                            Role = "Orders",
                            RoleGroupId = 2L
                        });
                });
            ...
            modelBuilder.Entity("XComm.Api.DataModel.RoleGroup", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2023, 12, 4, 10, 26, 40, 180, DateTimeKind.Local).AddTicks(7810),
                            GroupName = "Customer"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedBy = "admin",
                            CreatedDate = new DateTime(2023, 12, 4, 10, 26, 40, 180, DateTimeKind.Local).AddTicks(7811),
                            GroupName = "Kasir"
                        });
                });
